  ...
  render(): React.Node {
    return (
      <Site.Wrapper
        ...
        footerProps={{
          links: [
            <a href="#top">First Link</a>,
            <a href="#top">Second Link</a>,
            <a href="#top">Third Link</a>,
            <a href="#top">Fourth Link</a>,
            <a href="#top">Five Link</a>,
            <a href="#top">Sixth Link</a>,
            <a href="#top">Seventh Link</a>,
            <a href="#top">Eigth Link</a>,
          ],
          note:
